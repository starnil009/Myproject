var UrbanTrend;
(function (UrbanTrend) {
    angular.module('UrbanTrend', ['ui.router', 'ngResource', 'ui.bootstrap', 'ngMaterial', 'ngMessages', "ngAnimate"]).config(function ($stateProvider, $urlRouterProvider, $locationProvider) {
        // Define routes
        $stateProvider
            .state('home', {
            url: '/',
    ...
    angular.module('UrbanTrend').factory('authInterceptor', function ($q, $window, $location) {
        return ({
